...
const AlarmContainer = () => {
  ...
  return (
    <div className="alarm-page-container">
      <h1
        className="alarm-container-heading"
        style={{ color: activeAlarms ? "#232d31" : "#fff" }}
      >
        Alarms
      </h1>
      <div className="alarm-container-input">
        <input
          ...
          placeholder="Add a new alarm"
        />
        <div className="alarm-add-btn-container">
          <button className="add-alarm-button" onClick={HandleAddAlarm}>
            Set Alarm
          </button>
        </div>
      </div>
